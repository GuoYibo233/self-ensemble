...
# Ensemble generation with AVG method
# Usage: ./run_ensemble_avg.sh [DEVICE]
# Example: ./run_ensemble_avg.sh 0
...
echo "======================================"
echo "Ensemble Generation - AVG Method"
echo "Device: $DEVICE"
...
echo "======================================"
echo "All AVG experiments completed!"
