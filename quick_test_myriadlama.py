    ...
    for prompt in prompts[:6]:  # 只用前6个paraphrase节省时间
        ...
        with torch.no_grad():
            ...
            if max_prob.item() > best_prob:
                ...
                best_prediction = tokenizer.decode([max_token.item()], skip_special_tokens=True).strip()
...
if __name__ == "__main__":
    ...
    print(f"📊 Final Results: AVG={results['avg_accuracy']:.4f}, MAX={results['max_accuracy']:.4f}")